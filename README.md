...
**Authors:** [Serena Celeste Antonini](https://github.com/serenantonini) · [Valeria Crippa](https://github.com/valeria000777)

---

## Project Description

Electroencephalography (EEG) is a non-invasive technique that measures electrical brain activity through electrodes placed on the scalp. The ability to automatically detect eye state (open/closed) from these signals is relevant to several application domains, such as Brain-Computer Interfaces (BCI) and cognitive workload monitoring.
...
The project uses the **[EEG Eye State Dataset](https://www.kaggle.com/datasets/syednazmussakib/eeg-eye-state-dataset)**, publicly available on Kaggle, consisting of 14,980 observations with 14 continuous numerical features (signals measured in µV) collected from the following electrodes:
...
├── report.pdf                     # Full technical project report (in Italian)
...
5. **Training and Hyperparameter Tuning** — model-specific hyperparameter optimization, including 5-fold Cross-Validation for the RBF SVM (`C = 100`) and Cost-Complexity Pruning for the Decision Tree (`α = 0.000642`).
...
The **RBF SVM** achieved the best overall predictive performance, while the **Decision Tree** provided the best trade-off between accuracy, training speed, and model interpretability through explicit decision thresholds expressed in µV.
...
For the complete methodological analysis, including assumptions, experimental design, results discussion, and critical considerations, see the [`report.pdf`](./report.pdf).
